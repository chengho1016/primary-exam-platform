    ...
    <AppShell activePath="/admin/papers" mode="admin">
      <div className="app-content">
        ...
        <form action={updatePaperAction} className="form-panel edit-form">
          ...
          <div className="field-row"><div className="field"><label htmlFor="edit-access">會員存取</label><select defaultValue={paper.access} id="edit-access" name="access"><option value="FREE">免費</option><option value="MEMBERSHIP">會員試卷</option><option value="PURCHASE">單份權限（舊）</option></select></div><div className="field"><label htmlFor="edit-duration">建議時間（分鐘）</label><input defaultValue={paper.durationMinutes} id="edit-duration" min="1" name="durationMinutes" type="number" /></div></div>
