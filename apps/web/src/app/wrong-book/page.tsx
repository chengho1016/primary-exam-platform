  ...
  return (
    <AppShell activePath="/wrong-book">
      <div className="app-content">
        <header className="app-page-header"><div><h1>{child?.displayName ?? "孩子"}的錯題本</h1><p>答錯題目會自動加入；重新答對後會標記為已改善。</p></div><ButtonLink href={practiceHref}>開始新練習</ButtonLink></header>
